<section id="news" class="mt-10 px-2 lg:px-2">
    <div class="py-8 mt-8 mx-auto max-w-screen-xl lg:py-16 lg:px-10">
        ...
        <!-- RSS Widget Section -->
        <div class="mt-8">
            <rssapp-imageboard id="oEpGwCzmeKaDRfDV"></rssapp-imageboard><script src="https://widget.rss.app/v1/imageboard.js" type="text/javascript" async></script>
        </div>
    </div>
</section>
