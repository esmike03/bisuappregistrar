...
@section('dashboard')
    @php
        $category = auth()->guard('admin')->user()->campus; // Replace with your desired category
        $appointmentCount = $appointments->where('appstatus', 'pending')->where('campus', $category)->count();
                                ...
                                @foreach ($filteredAppointments as $appointment)
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3 text-xs">
                                            <span
                                                class="uppercase px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-amber-300 dark:text-purple-900">
