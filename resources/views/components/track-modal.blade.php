<!-- Main modal -->
  <div x-show="modalOpen" class="bg-black backdrop-filter backdrop-blur-md bg-opacity-5 m-auto flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <div class="relative p-4 w-full max-w-md max-h-full">
          ...
          <!-- Modal body -->
          <form class="p-4 md:p-5" method="GET" action="{{ route('appointment.search') }}">
            @csrf
