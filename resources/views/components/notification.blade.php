...
<div onclick="notificationHandler(false)" class="w-full h-full mt-3 bg-gray-800 backdrop-filter backdrop-blur-lg bg-opacity-10 top-16 overflow-y-auto overflow-x-hidden fixed sticky-0"
    id="chec-div">
    <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
    <div class="w-full absolute z-100 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700"
        id="notification">
...
<script>
    ...
    const notificationHandler = () => {
        if (!flag3) {
            ...
            setTimeout(() => {
                checdiv.classList.add("hidden");
            }, 300); // Adjust to match the CSS transition duration
            flag3 = false;
        }
    };

    // Example to bind the function to a click event (assuming there's a button to toggle)
    document.getElementById("toggle-button").addEventListener("click", notificationHandler);
</script>
